...
exports.VoteEventWriter = void 0;
class VoteEventWriter {
    supabase;
    logger;
     ...
     */
    async batchWriteProposalVotes(votes) {
     ...
     */
    async batchWriteDisputeVotes(votes) {
    ...
    async recordEvent(record) {
        const { error } = await this.supabase
            ...
            event_data: record.event_data, // JSONB column
            slot: record.slot,
     ...
     */
    async getVoteStats(marketAddress) {
...
exports.VoteEventWriter = VoteEventWriter;
// ============================================================
// Usage Example
// ============================================================
/*
...
*/
//# sourceMappingURL=vote-writer.js.map