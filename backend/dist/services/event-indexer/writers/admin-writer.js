...
exports.AdminEventWriter = void 0;
class AdminEventWriter {
    supabase;
    logger;
     ...
     */
    async writeConfigInitialized(event) {
     ...
     */
    async writeConfigUpdated(event) {
        const startTime = Date.now();
        try {
     ...
     */
    async writeEmergencyPauseToggled(event) {
        const startTime = Date.now();
        try {
...
exports.AdminEventWriter = AdminEventWriter;
//# sourceMappingURL=admin-writer.js.map